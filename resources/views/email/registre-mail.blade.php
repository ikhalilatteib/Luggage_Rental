...
<body class="body"
      style="padding:0 !important; margin:0 !important; display:block !important; min-width:100% !important; width:100% !important; background:#2e57ae; -webkit-text-size-adjust:none;">
                        ...
                        <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    <td class="img m-center"
                                                                        ...
                                                                        <img src="assets/img/logo/Luggage_Rental.png" width="191"
                                                                             height="60" editable="true" border="0"
                                                                             alt=""/></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                            ...
                                                            <tr>
                                                                <td class="fluid-img pb40">
                                                                    <div class="single-slider slider-height d-flex align-items-center slide-bg"
                                                                         style="background-image: url('{{asset('Doc/img/1411.jpg')}}'); height:350px; background-size: cover">
                                                                        <div class="container">
                                                                    ...
                                                                    <table width="100%" border="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td class="text-button"
                                                                                style=" color:#000000; font-family:'Fira Mono', Arial,sans-serif; font-size:14px; line-height:18px;">
                                                                               <h4>Hello {{$username}}!</h4>
                                                                                <p>
                                                                                    Congratulations!
                                                                                    <br>You are on the right track to be able to sell your luggage.
                                                                                    <br>By connecting to our site with your email and password, you can now apply for your sells as you want and completely free.
                                                                                    <br>we suggest you take a look at our privacy and terms of use.
                                                                                </p>
                                                                                <p>
                                                                                    <br>Have a nice day
                                                                                    <br><a style="color:blue;" href="/luggage">Luggage Rental</a> Team
                                                                                </p>
                                                                ...
                                                                <tr>
                                                                    <td class="img" width="52"
                                                                        ...
                                                                        <a href="#" target="_blank"><img
                                                                                src="assets/images/t_free_ico_facebook.jpg"
                                                                                width="42" height="42" editable="true"
                                                                                border="0" alt=""/></a></td>
                                                                    <td class="img" width="52"
                                                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                        <a href="#" target="_blank"><img
                                                                                src="assets/images/t_free_ico_twitter.jpg"
                                                                                width="42" height="42" editable="true"
                                                                                border="0" alt=""/></a></td>
                                                                    <td class="img" width="52"
                                                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                        <a href="#" target="_blank"><img
                                                                                src="assets/images/t_free_ico_gplus.jpg"
                                                                                width="42" height="42" editable="true"
                                                                                border="0" alt=""/></a></td>
                                                                    <td class="img" width="42"
                                                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                                                        <a href="#" target="_blank"><img
                                                                                src="assets/images/t_free_ico_instagram.jpg"
                                                                                width="42" height="42" editable="true"
                                                                                border="0" alt=""/></a></td>
                                                                </tr>
                                                            </table>
                            ...
                            <tr>
                                <td class="text-footer"
                                    style="padding: 30px 15px; color:#ffffff; font-family:'Fira Mono', Arial,sans-serif; font-size:12px; line-height:22px; text-align:center;">
                                    <multiline>Luggage Rental &copy; 2020 All rights reserved</multiline>
                                </td>
                            </tr>
                        </table>
                    </td>
